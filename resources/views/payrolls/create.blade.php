...
<div class="page-heading">
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('payrolls.store')}}" class="needs-validation" method="post">
                    @csrf
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="number" class="form-control @error('allowances') is-invalid @enderror" id="allowances" name="allowances" value="{{ old('allowances')}}">
                        @error('allowances')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="number" class="form-control @error('deductions') is-invalid @enderror" id="deductions" name="deductions" value="{{ old('deductions')}}">
                        @error('deductions')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="datetime" class="form-control date @error('pay_date') is-invalid @enderror" id="date" name="pay_date" value="{{ old('pay_date')}}">
                        @error('pay_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
